...
ConVar cl_viewbob_scale		( "cl_viewbob_scale", "0.05", 0, "Magnitude of Oscillation"); //All we're doing here is declaring our convars, bools and floats for our camera bobbing code. 
