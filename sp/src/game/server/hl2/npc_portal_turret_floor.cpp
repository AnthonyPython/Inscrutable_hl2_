...
void CNPC_Portal_FloorTurret::Precache( void )
{
	...
	PrecacheSound("npc/turret_floor/turret_active_2.wav");
	PrecacheSound("npc/turret_floor/turret_search_3.wav");
	PrecacheSound("npc/turret_floor/turret_autosearch_5.wav");
	PrecacheSound("npc/turret_floor/turret_deploy_5.wav");
	PrecacheSound("npc/turret_floor/turret_retire_7.wav");
	PrecacheSound("npc/turret_floor/turret_tipped_5.wav");
	PrecacheSound("npc/turret_floor/turret_pickup_2.wav");
	PrecacheSound("npc/turret_floor/turret_fizzler_1.wav");
	...
	if ( gpGlobals->curtime > m_fNextTalk && m_iLastState != iNewState )
	{
		...
		switch ( iNewState )
		{
			case TURRET_SEARCHING:
				EmitSound( "npc/turret_floor/turret_search_3.wav" );
			...
			case TURRET_ACTIVE:
				EmitSound( "npc/turret_floor/turret_active_2.wav"  );
			...
			case TURRET_DEPLOYING:
				EmitSound( "npc/turret_floor/turret_deploy_5.wav" );
				m_fNextTalk = gpGlobals->curtime + 1.75f;
				break;

			case TURRET_RETIRING:
				EmitSound( "npc/turret_floor/turret_retire_7.wav" );
				m_fNextTalk = gpGlobals->curtime + 3.5f;
				break;

			case TURRET_TIPPED:
				EmitSound( "npc/turret_floor/turret_tipped_5.wav" );
				m_fNextTalk = gpGlobals->curtime + 1.15f;
				break;

			case PORTAL_TURRET_PICKUP:
				EmitSound( "npc/turret_floor/turret_pickup_2.wav" );
				m_fNextTalk = gpGlobals->curtime + 2.25f;
				break;

			case PORTAL_TURRET_DISSOLVED:
				EmitSound( "npc/turret_floor/turret_fizzler_1.wav" );
...
void CNPC_Portal_FloorTurret::ActiveThink( void )
{
	...
	if ( bEnemyVisible )
	{
		...
		Vector vEnemyWorldSpaceCenter = pEnemy->WorldSpaceCenter();
			...
			// Translate our target across the portal
			( vEnemyWorldSpaceCenter, vEnemyWorldSpaceCenter );
